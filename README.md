...
```
cd existing_repo
git remote add origin https://gitlab.kit.edu/ugwhn/bis_group6.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.kit.edu/ugwhn/bis_group6/-/settings/integrations)
